			...
			public void onClick(View v) {
				...
				new MyHttpAsyncTask<Void>() {
					...
					protected String doInBackground(Void... params1) {
						productListFromNet = engine.getHotProductListFromNet(ConstantValue.COMMON_URI.concat(ConstantValue.HOTPRODUCT), params);
						return null;
					}
...
//		    } 
	...
	public int getIdentifier() {
		return ConstantValue.HOTPRODUCTVIEW;
	}
}
