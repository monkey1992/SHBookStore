...
/**
 * 专题商品列表界面(由促销快报界面点击进入)
 * @author cjx
 *
 */
public class TopicProductListView extends BaseView {
			...
			public void onClick(View v) {
				...
				new MyHttpAsyncTask<Void>() {
					...
					protected String doInBackground(Void... params1) {
						productListFromNet = engine.getTopicProductListFromNet(ConstantValue.COMMON_URI.concat(ConstantValue.TOPICPRODUCTLIST), params);
						return null;
					}
	...
	private class MyAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.imgIsBargain.setVisibility(View.VISIBLE);
...
//		    } 
		...
		private class ViewHolder{
			...
			private ImageView imgIsBargain;
		}
		
	}

	//http://192.168.1.52:8080/RedBaby/topic/plist

	@Override
	public int getIdentifier() {
		// TODO Auto-generated method stub
		return ConstantValue.TOPICPRODUCTLISTVIEW;
	}
}
